 ...
 *                           (webhook setup_intent.succeeded then persists the PM + enables autopay)
 *   enable_existing_card  — marks autopay_enabled=1 when the contact already has a card on file
 *
