...
$stmt = $db->prepare("
    SELECT
        ...
        COALESCE(NULLIF(c.billing_phone,''), NULLIF(dc.phone,''), NULLIF(dc.mobile,''), NULLIF(ct.phone,''), NULLIF(ct.mobile,'')) as billing_phone,
        ...
        COALESCE(NULLIF(ct.phone,''), NULLIF(ct.mobile,''), NULLIF(dc.phone,''), NULLIF(dc.mobile,'')) as contact_phone,
          ...
          <div class="mw-content-grid">
              <div>
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          ...
                          <?php if ($billAddrFull): ?>
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="map-pin" class="mw-detail-icon"></i></span>Billing Address</span>
                          ...
                          <?php if ($svcAddrFull && $svcAddrFull !== $billAddrFull): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="map-pin" class="mw-detail-icon"></i></span>Service Address</span>
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          ...
                          <div class="mw-totals">
                              ...
                              <div class="mw-total-row">
                                  <span>GST (<?php echo round(($invoice['tax_rate'] ?: 0.05) * 100); ?>%)<?php if (!empty($invoice['gst_number'])): ?> <small class="text-muted" style="font-weight:400;font-size:0.78em;">Reg# <?php echo h($invoice['gst_number']); ?></small><?php endif; ?></span>
                  ...
                  <?php if ($invoice['status'] === 'paid' && !empty($invoice['paid_at'])): ?>
                      <div class="card">
                          ...
                          <div class="card-body">
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="calendar" class="mw-detail-icon"></i></span>Payment Date</span>
                                  <span class="mw-detail-value"><?php echo formatDateTime($invoice['paid_at']); ?></span>
                              </div>
                              <?php if (!empty($invoice['payment_method'])): ?>
                                  <div class="mw-detail-row">
                                      <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="credit-card" class="mw-detail-icon"></i></span>Method</span>
                              ...
                              <?php if (!empty($invoice['payment_reference'])): ?>
                                  <div class="mw-detail-row">
                                      <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="hash" class="mw-detail-icon"></i></span>Reference</span>
              ...
              <div>
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="activity" class="mw-detail-icon"></i></span>Status</span>
                              <span class="mw-detail-value"><?php echo getStatusBadge($invoice['status'], 'invoice'); ?></span>
                          </div>
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="calendar" class="mw-detail-icon"></i></span>Issue Date</span>
                              <span class="mw-detail-value"><?php echo formatDate($invoice['issue_date']); ?></span>
                          </div>
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="calendar" class="mw-detail-icon"></i></span>Due Date</span>
                              <span class="mw-detail-value"><?php echo formatDate($invoice['due_date']); ?></span>
                          </div>
                          <?php if (!empty($invoice['sent_at'])): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="send" class="mw-detail-icon"></i></span>Sent</span>
                                  <span class="mw-detail-value"><?php echo formatDateTime($invoice['sent_at']); ?></span>
                              </div>
                          <?php endif; ?>
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="calendar" class="mw-detail-icon"></i></span>Created</span>
                              <span class="mw-detail-value"><?php echo formatDateTime($invoice['created_at']); ?></span>
                          </div>
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="user" class="mw-detail-icon"></i></span>Created By</span>
                          ...
                          <div class="mw-detail-row" style="margin-top:10px;padding-top:10px;border-top:1px solid var(--mw-light);">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="refresh-cw" class="mw-detail-icon"></i></span>Autopay</span>
                              <span class="mw-detail-value">
                          ...
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="credit-card" class="mw-detail-icon"></i></span>Card on File</span>
                          ...
                          <?php if (!empty($invoice['pdf_version']) && $invoice['pdf_version'] > 0): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="file" class="mw-detail-icon"></i></span>PDF Version</span>
                                  <span class="mw-detail-value">
                          ...
                          <?php if (!empty($invoice['plan_id'])): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="link" class="mw-detail-icon"></i></span>Linked Plan</span>
                                  <span class="mw-detail-value">
                          ...
                          <?php if (!empty($invoice['visit_id'])): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="link" class="mw-detail-icon"></i></span>Linked Visit</span>
                                  <span class="mw-detail-value">
                                      <a href="../jobs/view.php?id=<?php echo $invoice['plan_id']; ?>">
