 ...
 * Handles file uploads for portfolio gallery images
 */
...
$filename = 'gallery_' . time() . '_' . bin2hex(random_bytes(4)) . '.' . $fileExtension;
...
json_response(true, 'Gallery image uploaded successfully', [
