...
<div class="card mb-4">
    <div class="card-body py-3">
        <form method="GET" class="form-inline flex-wrap" style="gap:8px;">
            <button type="button" class="mw-datepicker-trigger" data-mw-dp-commit="input" data-mw-dp-target="#trip-date-from"
                    data-mw-dp-range-group="trip-range" data-mw-dp-range-role="start" aria-haspopup="true" aria-expanded="false">
            ...
            <input type="date" id="trip-date-from" name="from" class="form-control form-control-sm" hidden
                   value="<?php echo htmlspecialchars($filterFrom); ?>">
            <span class="text-muted">to</span>
            <button type="button" class="mw-datepicker-trigger" data-mw-dp-commit="input" data-mw-dp-target="#trip-date-to"
                    data-mw-dp-range-group="trip-range" data-mw-dp-range-role="end" aria-haspopup="true" aria-expanded="false">
                <svg class="mw-datepicker-cal-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                <span class="mw-datepicker-date" data-mw-dp-label></span>
                <svg class="mw-datepicker-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
            </button>
            <input type="date" id="trip-date-to" name="to" class="form-control form-control-sm" hidden
