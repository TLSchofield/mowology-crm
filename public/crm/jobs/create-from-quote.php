                      ...
                      <div class="card-body">
                          ...
                          <div class="mw-form-row three mw-cfq-sched-row">
                              <div class="mw-form-group">
                                  ...
                                  <button type="button" class="mw-datepicker-trigger" data-mw-dp-commit="input" data-mw-dp-target="#startDateInput" aria-haspopup="true" aria-expanded="false">
                                  ...
                                  <input type="date" name="plan_start_date" id="startDateInput" class="form-control" hidden
                                         value="<?php echo date('Y-m-d'); ?>">
                              </div>
                              <div class="mw-form-group">
                                  <label class="form-label">End Date</label>
                                  <button type="button" class="mw-datepicker-trigger" data-mw-dp-commit="input" data-mw-dp-target="#plan_end_date" aria-haspopup="true" aria-expanded="false">
                                      <svg class="mw-datepicker-cal-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
                                      <span class="mw-datepicker-date" data-mw-dp-label></span>
                                      <svg class="mw-datepicker-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
                                  </button>
                                  <input type="date" name="plan_end_date" id="plan_end_date" class="form-control" hidden>
              ...
              function showFertilizerDatesSection(bundleId, appCount, seasonalScheduleJson) {
                  ...
                  for (var i = 0; i < appCount; i++) {
                      ...
                      html += '<div class="d-flex align-items-center mb-2" style="gap:8px;">' +
                          ...
                          '<button type="button" class="mw-datepicker-trigger mw-datepicker-trigger-sm" style="width:160px;" data-mw-dp-commit="input" data-mw-dp-target="#' + fertDateId + '" aria-haspopup="true" aria-expanded="false">' +
                              '<svg class="mw-datepicker-cal-icon" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>' +
                              '<span class="mw-datepicker-date" data-mw-dp-label></span>' +
                          '</button>' +
                          '<input type="date" id="' + fertDateId + '" name="fertilizer_dates[]" class="form-control form-control-sm" hidden value="' + dateVal + '" required>' +
                      '</div>';
                  }
                  rowsDiv.innerHTML = html;
                  card.style.display = 'block';
                  if (window.mwInitDatePickers) window.mwInitDatePickers(rowsDiv);
