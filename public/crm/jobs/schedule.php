...
$pageTitle = 'Schedule';
$activePage = 'schedule';
$extraHead = '<link href="/crm/css/mobile-cards.css?v=20260214j" rel="stylesheet">';
?>
          ...
          <div class="mw-mc-container" data-csrf="<?php echo htmlspecialchars($csrfToken); ?>">
              ...
              <div class="mw-mc-topbar">
                  ...
                  <div class="mw-mc-topbar-right">
                      <!-- GPS Tracking Status — mirrors topbar widget dot -->
                      <div class="mw-mc-gps-dot" id="mobileTrackingDot" title="Checking GPS...">
