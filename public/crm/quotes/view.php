              ...
              <div>
                  ...
                  <div class="card">
                      ...
                      <div class="card-body">
                          ...
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="calendar" class="mw-detail-icon"></i></span>Valid Until</span>
                          ...
                          <?php if (!empty($quote['email_opened_at'])): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="eye" class="mw-detail-icon"></i></span>Email Opened</span>
                                  <span class="mw-detail-value"><?php echo formatDateTime($quote['email_opened_at']); ?></span>
                              </div>
                          <?php endif; ?>
                          <?php if ($quote['viewed_at']): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="eye" class="mw-detail-icon"></i></span>Viewed</span>
                          ...
                          <?php if ($quote['accepted_at']): ?>
                              <div class="mw-detail-row">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="check-circle" class="mw-detail-icon"></i></span>Accepted</span>
                          ...
                          <?php if ($quote['access_token'] && in_array($quote['status'], ['sent', 'accepted'])): ?>
                              <div class="mt-3">
                                  <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="link" class="mw-detail-icon"></i></span>Customer Link:</span>
                  ...
                  <div class="card mw-followup-status-card <?php echo $fuCardClass; ?>">
                      ...
                      <div class="card-body">
                          ...
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="clock" class="mw-detail-icon"></i></span>Days Since Sent</span>
                              <span class="mw-detail-value">
                          ...
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="eye" class="mw-detail-icon"></i></span>Quote Viewed</span>
                              <span class="mw-detail-value">
                                  <?php if ($fuViewed): ?>
                          ...
                          <div class="mw-detail-row">
                              <span class="mw-detail-label"><span class="mw-icon-box"><i data-feather="bell" class="mw-detail-icon"></i></span>Follow-Ups Sent</span>
                              <span class="mw-detail-value">
                                  <?php if ($fuCount > 0): ?>
