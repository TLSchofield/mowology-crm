...
$dataFile = dirname(__DIR__) . '/includes/service-data/yard-maintenance-vancouver.php';
...
$ba = serviceBeforeAfterSection(['lawn', 'garden', 'cleanup'], 'Recent Yard Work in Vancouver');
if ($ba) {
