...
$dataFile = dirname(__DIR__) . '/includes/service-data/kitsilano-landscaping.php';
...
$ba = serviceBeforeAfterSection(['garden', 'lawn', 'cleanup'], 'Recent Work in Kitsilano and the West Side');
if ($ba) {
