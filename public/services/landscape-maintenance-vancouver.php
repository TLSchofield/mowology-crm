...
$dataFile = dirname(__DIR__) . '/includes/service-data/landscape-maintenance-vancouver.php';
...
$ba = serviceBeforeAfterSection(['garden', 'lawn', 'strata', 'cleanup'], 'Recent Landscape Maintenance Work');
if ($ba) {
