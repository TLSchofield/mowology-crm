...
SELECT
    ...
    0, 1, 10
FROM products WHERE name = 'DOLOPRIL LIME' AND is_active = 1 LIMIT 1;
...
SELECT
    ...
    0, 1, 5
FROM products WHERE name = 'SPRING FERTILIZER' AND is_active = 1 LIMIT 1;
...
SELECT
    ...
    0, 1, 5
FROM products WHERE name = 'MOSS CONTROLLER' AND is_active = 1 LIMIT 1;
...
SELECT
    ...
    0, 1, 5
FROM products WHERE name = 'One Off Lawn Cut' AND is_active = 1 LIMIT 1;
...
SELECT
    ...
    0, 1, 5
FROM products WHERE name = 'Premium Topsoil' AND is_active = 1 LIMIT 1;
...
SELECT
    ...
    0, 1, 8
FROM products WHERE name = 'AERATION' AND is_active = 1 LIMIT 1;
...
SELECT
    ...
    0, 1, 8
FROM products WHERE name = 'POWER RAKE' AND is_active = 1 LIMIT 1;
